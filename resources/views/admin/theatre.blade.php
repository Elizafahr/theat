    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ route('admin.theatres.index') }}">Театры</a></li>
    ...
    <tbody>
        @foreach ($theatres as $theatre)
            <tr>
                ...
                <td>
                    <form method="POST" action="{{ route('theatres.destroy', $theatre->id) }}">
                        @csrf
                        @method('DELETE')
